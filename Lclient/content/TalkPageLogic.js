...
function tryRemovePage(name){
    var page = findTalkPage(name);
    if(page != undefined){
        console.log("remove in js: " + page.clientName);
        page.destroy();
        page = null;
    }
}
...
function createTalkPage(name, language){
    ...
    if(component.status === Component.Ready){
        ...
        dynamicObject.titleName = name;
        dynamicObject.clientLanguage = language;
        dynamicObject.sendMessage.connect(messageList.addMessage);
